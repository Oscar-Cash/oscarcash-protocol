...
contract Treasury is ContractGuard, Epoch {
    ...
    modifier checkOperator {
        require(
            IOscarAsset(cash).operator() == address(this) &&
                IOscarAsset(bond).operator() == address(this) &&
                IOscarAsset(share).operator() == address(this) &&
    ...
    function initialize() public checkOperator {
        ...
        IOscarAsset(cash).burn(IERC20(cash).balanceOf(address(this)));
        ...
        checkOperator
    {
        ...
        IOscarAsset(cash).burnFrom(msg.sender, amount);
        IOscarAsset(bond).mint(msg.sender, amount.mul(1e18).div(bondPrice));
        _updateCashPrice();
        ...
        checkOperator    
    {
        ...
        IOscarAsset(bond).burnFrom(msg.sender, amount);
        ...
        checkOperator
    {
        ...
        IOscarAsset(cash).mint(address(this), seigniorage);
