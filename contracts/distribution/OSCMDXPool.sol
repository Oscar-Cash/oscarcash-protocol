...
contract MDXWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        mdex.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public virtual {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        mdex.safeTransfer(msg.sender, amount);
    }
}

contract OSCMDXPool is MDXWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCMDXPool: not start');
        _;
    }
    ...
    function stake(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCMDXPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCMDXPool: Cannot withdraw 0');
