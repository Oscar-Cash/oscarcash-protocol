...
contract OSCBACPool is BACWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCBACPool: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'OSCBACPool: Cannot stake 0');
        uint256 newDeposit = deposits[msg.sender].add(amount);
        require(
            newDeposit <= 50000e18,
            'OSCBACPool: deposit amount exceeds maximum 20000'
        );
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'OSCBACPool: Cannot withdraw 0');
