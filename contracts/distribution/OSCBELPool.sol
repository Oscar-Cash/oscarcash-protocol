...
contract OSCBELPool is BELWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCBELPool: not start');
        _;
    }
    ...
    function stake(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCBELPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCBELPool: Cannot withdraw 0');
