...
contract OSCSUSHIPool is SUSHIWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCSUSHIPool: not start');
        _;
    }
    ...
    function stake(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCSUSHIPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCSUSHIPool: Cannot withdraw 0');
