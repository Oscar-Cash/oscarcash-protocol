...
contract OSCUNIPool is UNIWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCUNIPool: not start');
        _;
    }
    ...
    function stake(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCUNIPool: Cannot stake 0');
    ...
    function withdraw(uint256 amount) 
        ...
        checkStart 
    {
        require(amount > 0, 'OSCUNIPool: Cannot withdraw 0');
