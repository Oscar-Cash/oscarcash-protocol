...
contract OSCFRAXPool is FRAXWrapper, IRewardDistributionRecipient {
    ...
    modifier checkStart() {
        require(block.timestamp >= starttime, 'OSCFRAXPool: not start');
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'OSCFRAXPool: Cannot stake 0');
        uint256 newDeposit = deposits[msg.sender].add(amount);
        require(
            newDeposit <= 50000e18,
            'OSCFRAXPool: deposit amount exceeds maximum 20000'
        );
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'OSCFRAXPool: Cannot withdraw 0');
